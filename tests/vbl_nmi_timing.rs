...
#[test]
fn frame_basics() {
    run_simple_test("tests\\vbl_nmi_timing\\1.frame_basics.nes", Duration::from_secs(10));
}
...
#[test]
fn nmi_suppression() {
    run_simple_test("tests\\vbl_nmi_timing\\5.nmi_suppression.nes",Duration::from_secs(5));
}
