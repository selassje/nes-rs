...
var ASM_CONSTS = {
 ...
 884910: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 884993: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 885062: () => { return window.innerWidth; },  
 885092: () => { return window.innerHeight; }
};
